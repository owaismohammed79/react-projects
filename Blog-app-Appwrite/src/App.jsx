...
function App() {
  ...
  useEffect(()=>{ //Whenever we want to fetch data from db or whatever we make use of this loading concept
    //This is coz as soon as the app loads, user might not see anything on the screen and we don't want that
